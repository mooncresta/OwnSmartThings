...
definition(
    ...
    author: "Harper Reed (@harper - harper@nata2.org)",
    description: "Send Smartthings events to a Discord webhook",
    category: "My Apps",
...
preferences {
    ...
    section("Message"){
		input "contentMessage", "text", title: "Message to Send", description: "What you want to post", required: true
	}
...
def eventHandler(evt) {
     ...
     */
	def json_body = [
            content: settings.contentMessage
        ] 
    ...
    try {
    	log.info(" Payload is ${json_params}")
